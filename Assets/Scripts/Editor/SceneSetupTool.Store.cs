    ...
    public static partial class SceneSetupTool
    {
        ...
        public static void SetupStore()
        {
            ...
            List<ShopItemSO> catalog = new()
            {
                ...
                // NOT (2026-08-19): ucuz "Yol Tasi" kullanici istegiyle KALDIRILDI — haritadan
                // seyahatin tek yolu artik Guclu Yol Tasi. Asset dosyasi (YolTasi.asset) silinmedi,
                // yalnizca katalogtan cikarildi (asset'ler silinmez kurali).

                // GUCLU YOL TASI: mesafeye gore BIRDEN COK harcanir (her tas haritanin ~1/4'u)
                // ama yolculuk BEDAVA — AP dusmez, zaman ilerlemez. TASLAK sayilar.
