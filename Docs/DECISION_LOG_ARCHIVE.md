# Karar Günlüğü — ARŞİV (tam tarihsel içerik)

> Bu dosya `Docs/DECISION_LOG.md`'nin **tam tarihsel arşividir**: faz-faz blow-by-blow uygulama
> detayları, dosya-alan enumerasyonları, eski test akışları ve o günün "sıradaki iş" notları.
> 2026-07-28'de (TASK-003) ana logdan buraya taşındı — **hiçbir içerik silinmedi, yalnızca yer değiştirdi.**
>
> **Buradaki bilgi TARİHSELDİR, canonical DEĞİLDİR.** Güncel/geçerli olan:
> - Aktif kararlar + tuzaklar → `Docs/DECISION_LOG.md`
> - Denge/stat sayıları (AP, öz, seviye…) → `Docs/GAME_DESIGN.md` (tek doğruluk kaynağı)
> - İleriye dönük plan → `ROADMAP.md`
> - Hikaye/mekanik iskeleti → `Docs/GAME_DESIGN.md §5` · karo hattı → `Docs/TILE_PIPELINE.md`
>
> Aşağıdaki metinde geçen sayılar (ör. "3 AP/dilim", "CollapseConfig 5") o tarihteki hâlleridir;
> sonradan değişmiş olabilir — sayı arıyorsan GAME_DESIGN.md'ye bak, buraya değil.
>
> Arşive alınma: 2026-07-28 · Arşivlenen içeriğin kapsadığı dönem: 2026-06-16 → 2026-07-26.

---

## NOT: aşağıdaki "Bir Sonraki Adım / güncel durum" blokları BAYATTIR

Ana logdan silinen "Son push / güncel durum / DÖNÜŞTE SIRADAKİ İŞLER" blokları, tarihsel kayıt
olarak burada tutuluyor. **Bunlar 2026-06-25 tarihli fotoğraflardır ve artık geçerli değildir**
(orada "commit bekliyor" denen her şey o zamandan beri commit'lendi). Güncel durumun canlı kaynağı
Watson'ın kendi hafızasıdır; DECISION_LOG'da tutulmaz.
